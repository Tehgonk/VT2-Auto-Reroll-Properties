...
This script automates the rerolling process by crating a menu system with 97 possible item property combinations that once selected, will reroll the item until the chosen combination is found.
